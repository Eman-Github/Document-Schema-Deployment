...
PGPASSWORD=$POSTGRESQL_DB_PASSWORD PGSSLROOTCERT=$POSTGRESQL_DB_CERTIFICATE psql 'host=$HOSTNAME port=31175 dbname=$DATABASE user=$USERNAME sslmode=verify-full' << EOF
